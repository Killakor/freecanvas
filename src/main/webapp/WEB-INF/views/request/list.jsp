...
#requestmainimg {
	background-image: url(../resources/image/requestmainimg.png);
...
<body>
    ...
    <div id = "requestmainimg">
        <div class="container text-center paddingtop84">
            <p class="titletext ">Request</p>
            <p class="titlesubtext paddingtop20">Ask as much as you want.</p>
            <div>
	...
	<div class = "container">
		<div class="container text-center">
	        <p class="blackfont paddingtop57">Request</p>
	    </div>
