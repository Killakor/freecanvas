	...
	<div class ="contentcontainer padding-top50">
		<form method = "post">
			...
			<div class = "form-group">
				...
				<input type = "text" class="form-control titlebox" name="title" value = "${item.title}">
			</div>
			
			<div class = "form-group">
				<label for="content" class= "titlefont">Content</label>
				<textarea id="summernote" class="form-control" rows="5" id="content" name="writing">${item.writing}</textarea>
			</div>
